...
test("tinycrypt/tests/secboot_sha256_000.elf")
test("tinycrypt/tests/secboot_sha256_001.elf")
test("tinycrypt/tests/secboot_sha256_010.elf")
test("tinycrypt/tests/secboot_sha256_011.elf")
test("tinycrypt/tests/secboot_sha256_100.elf")
test("tinycrypt/tests/secboot_sha256_101.elf")
test("tinycrypt/tests/secboot_sha256_110.elf")
test("tinycrypt/tests/secboot_sha256_111.elf")
test("tinycrypt/tests/secboot_hmac.elf")
test("tinycrypt/tests/secboot_ecc_dsa.elf")
test("tinycrypt/tests/naked_secboot_sha256.elf")
test("tinycrypt/tests/naked_secboot_hmac.elf")
test("tinycrypt/tests/naked_secboot_ecc_dsa.elf")
